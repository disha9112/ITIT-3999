...
class ConviSTFT(nn.Module):
    ...
    def __init__(self, win_len, win_inc, fft_len=None, win_type='hamming', feature_type='real'):
        ...
        kernel, window = init_kernels(
            win_len, self.fft_len, win_type, invers=True)
        self.register_buffer('weight', kernel)
        self.feature_type = feature_type
...
#         self.cmap_custom = matplotlib.colors.LinearSegmentedColormap(
#             'testCmap', segmentdata=cmap_custom, N=256)
#         self.cmap_custom2 = matplotlib.colors.LinearSegmentedColormap(
#             'testCmap2', segmentdata=cmap_custom2, N=256)
